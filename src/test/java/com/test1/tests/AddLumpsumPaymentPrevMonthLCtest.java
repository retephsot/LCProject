...
public class AddLumpsumPaymentPrevMonthLCtest extends TestBase

{
	

  @Test (dataProvider = "dataProvider")
  public void testSuccessfulLumpsumPayAddLCPrevMonth(String casenumber, String day, String month, String year,
		  String amount) throws InterruptedException, IOException 
  {
	...
	boolean testResult = defaultlandingpage.ClickResearchCasesLink()
										   .clickCaseNumbertLink(casenumber)
			 						       ...
			 						       .ClickContinueLinkwithOutFillingOut()
			 						       .ClickContinueLinkwithOutFillingOut()
			 						       .CreateLumpsumPaymentPrevMonthLifeCon(amount, year, day)
